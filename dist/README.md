# db2eventstore-grafana
IBM Db2 Event Store Data Source for Grafana

## Grafana Datasource - an IBM DB2 Event Store backend datasource

More documentation about datasource plugins can be found in the [Docs](https://github.com/grafana/grafana/blob/master/docs/sources/plugins/developing/datasources.md).

The IBM Db2 Event Store backend implements 4 urls:
...
## Installation within an IBM Db2 Event Cluster

More information to come:
 * Will pull a prepared image from dockerhub
